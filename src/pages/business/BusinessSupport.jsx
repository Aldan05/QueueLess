...
const BusinessSupport = () => {
  ...
  const faqs = [
    {
      question: "How do I manage my active queue?",
      answer: "You can manage your queue from the Dashboard or Queue Management tab. Use the 'Call Next' button to proceed to the next customer, or mark customers as 'Skipped' if they aren't present."
    },
    {
      question: "How do I update my business verification documents?",
      answer: "Head over to the Verification Documents tab in your sidebar. From there, you can view your current status and upload any missing or requested compliance documents."
    },
    {
      question: "Can I add multiple staff members?",
      answer: "Yes! Navigate to Staff Management to invite your team members. You can assign them specific counters so they can independently manage portions of your queue."
    },
    {
      question: "How is my average wait time calculated?",
      answer: "Our system automatically calculates your average wait time based on the historical data of how long it takes to transition a customer from 'Waiting' to 'Served'. This adjusts dynamically in real-time."
    }
  ];
  ...
  return (
    <div className="space-y-8 pb-10 animate-fadeIn text-gray-900 dark:text-gray-100">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-white dark:bg-slate-800 p-8 rounded-[2rem] shadow-sm border border-gray-100/80 dark:border-slate-700 relative overflow-hidden">
        <div className="absolute right-0 bottom-0 w-64 h-64 bg-blue-50/50 dark:bg-slate-700/50 rounded-full blur-3xl translate-y-1/2 translate-x-1/4"></div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          <div className="bg-white dark:bg-slate-800 p-8 rounded-[2rem] shadow-sm border border-gray-100/80 dark:border-slate-700">
            <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-2">
              <FiMessageSquare className="text-blue-500" /> Send us a message
            </h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button 
                ...
                className="flex items-center justify-center gap-2 w-full sm:w-auto px-8 py-3.5 bg-blue-600 hover:bg-blue-700 text-white text-sm font-bold rounded-xl transition-all disabled:opacity-70 active:scale-[0.98]"
              >
                {isSubmitting ? (
              ...
              {faqs.map((faq, index) => (
                ...
                >
                  ...
                  >
                    ...
                    <span className={`shrink-0 w-8 h-8 rounded-full flex items-center justify-center transition-colors ${openFaq === index ? 'bg-blue-100 dark:bg-blue-900/40 text-blue-600 dark:text-blue-400' : 'bg-gray-100 dark:bg-slate-700 text-gray-500 dark:text-gray-400'}`}>
        ...
        <div className="space-y-6">
          <div className="bg-gradient-to-br from-blue-600 to-indigo-700 p-8 rounded-[2rem] text-white shadow-md relative overflow-hidden">
